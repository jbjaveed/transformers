...
def quac_convert_example_to_features(example, max_seq_length, doc_stride, max_query_length, is_training):
    features = []
...
def quac_convert_examples_to_features(
    ...
    Example::
        ...
        features = quac_convert_examples_to_features(
            examples=examples,
            tokenizer=tokenizer,
    ...
    def get_train_examples(self, data_dir, filename=None):
        ...
        Args:
            ...
            filename: None by default, specify this if the training file has a different name than the original one
                which is `train-v1.1.json` and `train-v2.0.json` for quac versions 1.1 and 2.0 respectively.
